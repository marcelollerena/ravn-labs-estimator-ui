...
- **No AI attribution**: Never add "Generated with Claude Code", "🤖 Generated with...", or any AI tool signature to PR descriptions, commit messages, or any public-facing content
- **Base branch**: Always target `development` unless explicitly told otherwise
- **No force push**: Never force push when creating or updating PRs
