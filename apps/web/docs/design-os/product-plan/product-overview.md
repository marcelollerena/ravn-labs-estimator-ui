...
- **RequestFeature** — A discrete feature extracted from a PRD
- **Estimate** — The AI-generated and human-reviewed estimate for a project
- **EstimateFeature** — A single feature within an estimate with complexity/hours/confidence
- **EstimateRisk** — A risk identified for an estimate with likelihood/impact/mitigation
- **EstimateQuestion** — An ambiguity surfaced during estimation
...
- **CalibrationEntry** — A post-project accuracy record
...
1. **Shell** — Set up design tokens and application shell (sidebar navigation, page header)
2. **PRD Ingestion** — Upload/parse PRDs, review AI extraction, confirm for estimation
3. **AI-Driven First-Pass Estimation** — (future milestone)
4. **Human Review & Adjustment** — (future milestone)
5. **Estimate Output & Export** — (future milestone)
6. **Historical Projects & Calibration** — (future milestone)
