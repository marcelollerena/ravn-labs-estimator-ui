...
import type { EstimationRequest, RequestFeature, SourceFormat } from '../types';
...
interface ExtractionReviewProps {
  ...
  onUpdateFeature?: (
    requestId: string,
    featureId: string,
    updates: Partial<RequestFeature>,
  ) => void;
          ...
          <section className="rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="px-4 py-3">
              {isEditingTitle ? (
                ...
                >
                  {request.title || (
                    <span className="text-zinc-300 dark:text-zinc-600">Untitled</span>
                  )}
                </p>
              )}
            </div>
